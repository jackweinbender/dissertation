...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% THE \temple AS A SITE OF MEMORY %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{The \temple as a Site of Memory}
...
\end{translation}
\noindent
In all of the accounts of the returnees, the construction of the \temple is of central concern. In the case of 2 Chronicles and Ezra, the construction of the \temple was the impetus for the returnees to go back to the land and formed their central mission, as commanded by Cyrus, and for Haggai and Zechariah as a central competent of the establishment of the Golah community. The present, social importance of the \temple during the \secondtemple period, therefore, continued to augment the memory of the \firsttemple.

Just as the centralization efforts of Josiah and Hezekiah served to augment the memory of \solomonstemple during the \bce{seventh and sixth centuries}, so too the importance and \emph{reality} of the \secondtemple reinforced the memory of the \firsttemple. Unlike the idea of the Davidic dynasty (which was largely an abstraction during the early \secondtemple period), the memory of the \firsttemple could be concretely tied to not only a geographic location, but to a physical structure. Although the \secondtemple 
