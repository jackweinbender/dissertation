...
Thinking in terms of social memory requires us to consider the relationship between the texts in \emph{social} terms. Doing so requires us to ask not only \emph{what} received traditions the \chronicler%
