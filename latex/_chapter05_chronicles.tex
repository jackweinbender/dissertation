...
major Pentateuchal strata vis-à-vis Chronicles, that the work has
likewise played an important role as memory studies has become an
increasingly influential lens tough which to view the biblical
...
utilized an altar at a secondary location vis-à-vis the primary cult
site of the time (viz. the tabernacle). At the same time, the Chronicler
understood that the future location of the temple would be in Jerusalem
and had to deal with the fact that David not only made the offerings,
but did so at the command of Yahweh. To resolve these tensions, the
Chronicler was able to assert that David, indeed, made sacrifices
outside the tabernacle, but with his offerings, he laid the groundwork
