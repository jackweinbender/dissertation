...
Yet, neither work cites \emph{any} major work on the topic of memory. A number of exceptions to this tendency, however, are worth noting: Ehud Ben Zvi, Ron Hendel, Ian Wilson, and Daniel Pioske, to name a few.%
    \footnote{%
        \Cite{benzvi_st2017};
        ...
        \cite{pioske2015};
        \cite{smith_cbq2002}.}
Yet, even most of these authors focus on ``cultural'' memory, that is, the diachronic processes at work and evaluating how and what is ``preserved'' in the collective memory. Comparatively few scholars have focused on ``social'' memory and the contemporary forces that shape the perception of the remembered past. Thus, one of my goals in this project will be to deal more directly with ``social'' memory and not just ``cultural'' memory.
