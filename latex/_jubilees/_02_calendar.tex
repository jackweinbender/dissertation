...
% TODO: "maybe one more sentence at the end to transition this paragraph to the next"
...
%TODO: "You should (1) combine these paragraphs and add a sentence at the end or (2) expand to at least three sentences in length."
...
%TODO: "Bergsma also points out that it entails the reoccupation of a land "unjustly occupied" by the Canaanites and adduces evidence form Jub 10 (v 24 I think) to support that claim."
...
Such an ideology, however, is not confined only to the abstract \emph{idea} of the past, but carries with it concrete political implications. It is significant, I think, that the book of \jub was likely composed near the time of the Maccabees when discourses about national sovereignty and messianic renewal were widespread. Of course, I am not suggesting that \jub is specifically referencing the Maccabean revolt,%
%TODO: "particularly if you follow VanderKam and date the final form of the text to post 140 BCE."
