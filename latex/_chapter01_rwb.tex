...
scrolls\footnote{I think this perception is a bit over-blown. On the one
  hand, Genesis Apocryphon and the \textasciitilde{}temple-scroll get a
  lot of attention, to be sure, but Jubilees and Jewish Antiquities do
  as well.} is symptomatic, I think, of some of the ``methodological
...
communication;\footnote{\textcite[276]{zahn_jbl2012}; See also
  newsome\_grossman2010 {[}199{]}} in this way, genre functions as a
sort of ``literary body language.''
