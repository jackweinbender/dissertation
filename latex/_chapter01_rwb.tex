...
Early adopters of the Vermes' taxonomy experimented with applying the
...
their \emph{Vorlagen} (forming the ``upper bound'') and texts which are
\emph{too close} to their \emph{Vorlagen} (forming the ``lower bound'').
At the upper bound, for example, the \emph{Book of the Watchers} and the
\emph{Book of Giants} clearly are rooted in the biblical text, yet most
scholars do not consider them sufficiently dependent on the text of
Genesis to be considered ``rewritten Bible.'' Conversely, at the lower
bound, the Samaritan Pentateuch and 4QReworkedPent, although they
certainly modify their \emph{Vorlagen} and in that sense are
``rewritten,'' are often considered ``text editions'' rather than
rewritten works. Likewise, the Targums and LXX, as translations, are
frequently excluded from discussions of RwB at the lower bound.
