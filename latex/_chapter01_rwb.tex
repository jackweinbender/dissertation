...
In his seminal work \citetitle*{vermes1961}, \Vermes
...
Since the publication of \citetitle{vermes1961}, \vermes's
...
\citetitle{vermes1961} to the present focusing on three key questions and
...
The primary purpose of \citetitle{vermes1961} was not to offer a clear
...
In chapter five, \vermes proceeds with a ``progressive
...
The third part of \citetitle{vermes1961} is titled ``Bible and Tradition''
...
texts. Of course, when \citetitle{vermes1961} was first published in 1961
...
{[}im{]}precision'' attributed to \citetitle{vermes1961} and
...
\citetitle{vermes1961}, of course, \vermes treats these
...
For the sake of simplicity, I will follow \vermes in
...
In contrast, \ga seems to have very little interest in
...
he observes that \lab likewise differs with
\jub in its omission of halakhic matters and its
``highly selective reproduction of the
text.''\autocite[110]{nickelsburg_stone1984} This selectivity also
differs from the \ga, which otherwise is ``characterized
by the addition of lengthy non-biblical
incidence.''\autocite[110]{nickelsburg_stone1984}

Ultimately, Nickelsburg differs from \vermes mainly in
the way he views the Bible during the late \secondtemple period.
...
\jub, with earlier inner-biblical or later haggadic
traditions. Because Nickelsburg treats \rwb as a
...
(Narratives),'' adopts the term \rwb to talk about texts
...
he follows \vermes closely in how he imagines
\rwb to function. Yet, compared to
\vermes, he operates with a slightly expanded list of
rewritten texts. In addition to \jub,
\ga, Ps. Philo's \lab and Josephus's
\ant, he also includes the \emph{Assumption of Moses}
and the \templescroll. Furthermore, he makes a point to
...
major contribution is his explicit rejection of \rwb as
...
Harrington's inclusion of the \templescroll marked a
...
Instead, he observes that while texts such as \jub and
...
Yet, it is not at all clear to me what we have gained by upholding
...
the late \secondtemple period.\autocite{campbell_zsengeller2014}
In his article, Campbell observes that the rewriting of non-scriptural
texts has by-and-large been ignored by scholars or \rwb
and offers a number compelling examples of \secondtemple texts
which rewrite non-scriptural material following the same basic process
as \rwb. In particular, Campbell notes that while
\ant 1--11 focuses on biblical material,
\ant 12--13 offers a rewriting of the \emph{Letter of
Aristeas} and portions of 1 Macc. These rewritings maintain the
``structure and flow'' of ther base texts, just like
\rwb, but it is generally agreed that neither 1 Macc nor
...
mother found in 2 Macc 3--7. As with \ant 12--13, 4
...
What these examples lack, as compared with \vermes's
understanding of rewriting, is a tradition of \emph{interpretation}
(\emph{aggadah} for \vermes) which can account for the
...
\vermes was arguing for in \citetitle{vermes1961}: that
