...
which produced something entirely new. As such, Vermes used the term
rewritten Bible to describe an exegetical process by which ``the
...
In other words, according to Vermes, the authors of rewritten Bible
texts \emph{implicitly} made use of interpretive traditions that later
works such as the Talmud and Mishnah expressed \emph{explicitly}.
...
cannot help but push back against Vermes here, and scholars' desire to
...
Palestinian Targums stop there.
...
Genesis Apocryphon and the Temple Scroll get a lot of scholarly
...
Palestinian Targums makes sense diachronically, but formally, they are
translations and not ``new compositions.'' Within
...
\subsection{\texorpdfstring{RwB as a
...
theory in his 2010 article, as well. (][. Notable exceptions include
\textcite{brooke_dsd2010}]{machiela_jjs2010} Zahn addresses the
difficulty that Harrington addresses by noting that works may
participate in multiple genres simultaneously. While older conceptions
of genre ``pigeonhole'' texts to specific genres, modern genre
theorists---she cites Fowler---now prefer to talk about texts
...
communication;{[}\textcite{zahn_jbl2012}, 276; See also
newsome\_grossman2010, 199{]} in this way, genre functions as a sort of
``literary body language.''
