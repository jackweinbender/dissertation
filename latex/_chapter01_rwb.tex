...
that given a slightly broader view of the RwB phenomenon it is worth
considering that the phenomenon of rewriting, as a literary process, was
not primarily concerned with nor necessarily tied to the
\emph{explication} of a scriptural \emph{Vorlage}.
...
normative force in the interpretation of the original account. On the
other hand, this is precisely what Vermes was arguing for in
\emph{Scripture and Tradition}: that the changes made by the biblical
rewriters were not only descriptive of \emph{how} they understood their
\emph{Vorlagen}, but that the purpose of these texts were somehow
functioned prescriptively within the tradition of biblical
interpretation.
