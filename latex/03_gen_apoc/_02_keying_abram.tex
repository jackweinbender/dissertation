...
Having dealt with the \ga as the product of cultural memory in terms of its relationship to its inherited biblical memory % TODO: I feel like you did you more than that in the preceding section.
% I think you also highlighted that RwB is not really a useful category for discussing Genesis Apocryphon.
(including the traditions which were ancillary to Genesis proper), we may now turn our attention to the ways that the \ga addressed its audience at the level of \emph{social} memory. In this section I will address the way that the \ga \emph{speaks to} its audience % TODO: You need to define what you mean by *speaks.*
...
As I have already noted, the narrative of the \ga is not simply a straight-forward retelling of Genesis from the perspectives of Lamech, Noah, and Abram, but participates more broadly in the ``biblical memory'' of Genesis. % TODO: As well as 1 Enoch and maybe Jubilees? 
However, what is most compelling about \rwb texts very often is the \emph{ways} that they adapt biblical memory. These adaptations can come at the level of story---by adding, removing, or rearranging events---or at the level of narrative discourse by describing events differently or with different emphases. In the case of \ga, and in particular in the account of Abram in \cols{19}{22}, % TODO: I think you need to find a place to quote these columns and perhaps briefly analyze the structure of them.
...
% TODO: Again, this is an important observation that I believe you need to ruminate on for one more sentence.
...
%
Jurgens has convincingly shown % TODO: Why is this convincing?
...
It is easy to imagine how the author of \ga would conceive of Abram's interaction with Pharoah in Gen 12 as analogous to other well-known court contests from Israel's biblical memory. % TODO: Should you quote the Genesis 12 account in your translation here to highlight what is included and what is not?
...
\begin{quote}
As no part of the palm has any waste, the dates being eaten, the branches used for Hallel, the twigs for covering [booths], and bast for ropes, the leaves for besoms, and the planed boards for ceiling rooms, so are there none worthless in Israel, some being versed in Scripture, some in Mishnah, some in Talmud, others Haggadah. (\genrab{41.1}) % TODO: Format
\end{quote}

The final comparison makes the claim that, like dealing with Israel, climbing these tall trees is perilous. The proof, for \GenRabbah, brings us back to the verse at hand. That Pharaoh was plagued by Yahweh when he took Sarai for himself demonstrates the danger in engaging with Israel as an adversary.

For our purposes, what is significant is that the authors of both the \ga and the \GenRabbah connect Ps 92 with this section of Genesis, but importantly, they use this connection for their own purposes. % TODO: What do you mean by this point?
...
The recasting of Abram's sojourn as ``diaspora,'' his conflict with Pharaoh as a court-contest along with the portrayal of Abram and Noah as dreamers can be understood in terms of social memory as the author of \ga pressing the stories of Genesis into existing literary genres. Insofar as ``genres'' can be understood as commonly understood literary conventions---a social ``contract'' of expectations between the author and her audience---they are socially defined and, for our purposes, function as what \halbwachs would call ``social frameworks.'' As Abram's sojourn in Egypt could be understood in new ways within the context of the diaspora, % TODO: It is unclear to me whether you mean diaspora as a setting for the story or as the context of putative composition.
