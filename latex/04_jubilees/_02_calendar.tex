...
% TODO: Transition from memory/praxis to calendars
...
\input{04_jubilees/jubilees_6_36-37.tex}
\noindent
...
Using the system of jubilees allowed the author of the book of \jub to align his system with significant events in the history of Israel. For instance, as Bergsma notes, within the framework of the book of \jub, the history of Israel from creation to the entrance to the land amounts to precisely 50 cycles of jubilees.\autocite[234--235]{bergsma2007}
    % FIXME: Cite Jub 50:2ff.
According to the book of \jub, the revelation occurs precisely 9 years (or, more accurately, one week and two years) into the 49th jubilee cycle since creation. Thus, the Israelites enter the land in the Jubilee year of the 50th jubilee. The significance of this juxtaposition should not be missed---the Jubilee of Lev instructed that all ancestral lands be returned and redistributed among the tribes of Israel. The author of the book of \jub has, therefor, connected the entrance of the land to the rightful repossession of inalienable ancestral landholdings, as the \jub legislation demands.  


% TODO: Jubilee cycles of the past provides a framework for understanding the relationship of the *present* to the distant past. When is the next Jubilee? What happened in earlier jubilees?


% TODO: Some kind of Concluding statement before conclusion 