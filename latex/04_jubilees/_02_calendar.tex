...
The 364 day year is considered ``complete'' (Eth. \eth{}{TODO:}) by the Angel such that proper observance maintains synchrony year-over-year. In other words, adding or subtracting days from this calendar renders a ``revolving'' calendar \visavis the absolute reference of the heavenly tablets.%
...
\input{includes/jubilees_6_36-37.tex}
\noindent
