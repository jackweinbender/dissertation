...
% TODO: Explain this within the frame that I've set up

The larger cycles of weeks and jubilees likewise carry significance beyond their simple numerical values.
    % TODO: the jubilee cycle is used as a ``metaphor'' (key? frame?) as a way of understanding and interpreting the past of Israel
