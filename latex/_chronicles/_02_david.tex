...
The reason an explanation is so difficult to come up with, ultimately, is that the \chronicler makes a claim about David which does not seem to have any basis in other related material. 


The assumption of all these approaches has been that the \chronicler---with his disinct theological \emph{Tendenz}---sought to rationalize the fact that Solomon, and not David, built the temple. As Japhet writes:
