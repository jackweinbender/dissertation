...
Based on this superscription, it is reasonable to suppose that the
...
Writing in the voice of these early biblical figures formally places
...
The ancient use of the term \psa denoted spurious texts
...
Because the implied author is a construction of the reader, it is
...
advantage of basing the definition of \psy on the idea
...
generally misses the point. In the case of \psy,
...
\psgraphic texts is the intentionality on the part of
...
\psy, ``implied'' still fits quite well (since we can
...
\subsection{Scripture, \Psy and Memory
...
The rhetorical force of this particular authorial voice, as observed by
...
While retelling portions of Genesis as first-person narrative reorients
...
The reading of \ga 19--20 as a Hellenistic Jewish
...
The process of this transcription, which he terms ``fictionalization,''
is described by Jurgens in the six distinct narrative units within cols.
19-20 of \ga which describe Abram and Sarai's sojourn in
...
In each section Jurgens notes the ways that the \ga
...
description of the ways that the \ga utilizes these
...
While \halbwachs addressed the fact that memories are
...
Where \halbwachs limits his discussion to the describing
...
One of the primary features of these novellas is their setting. Jurgens
...
case of \ga, although not properly ``diaspora,'' Abram
...
geographic items (Tobit 5:6). Likewise, \ga seems to
...
\ga seems to be turning the story to engage with the
