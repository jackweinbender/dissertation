...
%
\footnote{\cite[183]{bernstein_textus2005}. I make special note of the fact that Bernstein places the term ``commentary'' in scare quotes to indicate that he is not saying that \rwb is formally ``commentary.'' Yet, the ovearching principle remains that \rwb is implictly ``commenting'' on the biblical text. See also Fraade's work in this area: \cite{fraade_bakhos2006} and \cite{fraade_zsengeller2014}.}
%
