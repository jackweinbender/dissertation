...
psychological perspective of Freud and Bergson, Assmann's taxonomy is
rooted in ethnological research on oral traditions, specifically that of
Jan Vansina and his notion of a ``floating gap'' between the present and
the distant past.\autocite{vansina1985} Vansina observes that in oral
cultures often there is an abundance of common knowledge about current
goings-on and a similar abundance of shared knowledge about the distant
past (esp.~with regard to origin stories and the like), but there often
exists a gap for the not-so-distant past. The distribution of collective
knowledge, therefore, is unevenly distributed between two poles of
memory, although members of the society in question may not perceive
such a gap in their own reconstruction of the
...
Among the critics of Halbwachs's presentist posture, Barry Schwartz in
particular has attempted to offer a more nuanced approach to addressing
what he argues is the continued impact of the past on collective
