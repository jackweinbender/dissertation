...
\subsection{The Memory Boom}\label{the-memory-boom}}
...
memory does not recognize.''\autocite[94]{yerushalmi1989} Even the most
theory-conscious historian cannot help but occasionally slip into older
discourses about ``what really happened'' particularly when stated over
and against memory in the form of received tradition. All of this is not
to say that modern history writing is in any meaningful sense
``objective,'' nor that the historian is able to remove herself from her
...
consiousness\autocite[282]{winter2006} Kerwin Klein, for example, traces
the origins of scholarly discourse surrounding memory and lists five
narratives that others have offered as explanations for the origins of
memory discourse in society generally:
...
of social engagement, I am in fact, quite sympathetic to Klein's
critique overall. As a methodology for pursuing meaningful historical
investigation memory is not equipped for the task.
